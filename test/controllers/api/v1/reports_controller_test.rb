...
class Api::V1::ReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "create should return created report as a geoJSON feature" do
    ...
    assert_kind_of String, body["properties"]["name"]

    report = Report.find(body["properties"]["id"])
    assert_equal report.can_update_until.httpdate, body["properties"]["canUpdateUntil"]
  end
